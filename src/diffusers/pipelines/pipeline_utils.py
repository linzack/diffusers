    ...
    def save_pretrained(
        ...
        **kwargs,
        ...
        for pipeline_component_name in model_index_dict.keys():
            ...
            print(f"[DEBUG SAVE] Starting search for component '{pipeline_component_name}' of type {model_cls}...", flush=True)
            ...
            if save_method_name is None:
                logger.warning(
                    f"self.{pipeline_component_name} of type {type(sub_model)} cannot be saved."
                )
